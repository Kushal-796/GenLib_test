...
//                       // Query 'lending_requests' collection
//                       // Filter for documents where penaltyAmount is greater than 0
//                       // and it has not been paid yet (optional, but logical for "penalties to show")
//                       stream: FirebaseFirestore.instance
//                           .collection('lending_requests')
//                           .where('penaltyAmount', isGreaterThan: 0) // Filter for documents with penalties
//                           .where('isPaid', isEqualTo: false) // Show only unpaid penalties
//                           .orderBy('penaltyAmount', descending: true) // Order by amount or timestamp
//                           .orderBy('timestamp', descending: true)
//                           .snapshots(),
//                       builder: (context, snapshot) {
//                         if (snapshot.connectionState == ConnectionState.waiting) {
